...
docker build -t git-registry.gibb.ch/thomas.staub/microservices/play.frontend:1.0 .

docker push git-registry.gibb.ch/thomas.staub/microservices/play.frontend:1.0